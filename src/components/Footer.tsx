      ...
      <div className="max-w-[1440px] mx-auto px-4 md:px-6 py-12">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="lg:col-span-1">
            ...
            <p className="text-sm mb-4 text-gray-400">
              Your trusted platform for finding houses, hostels, doctors, catering services, and exploring Rajshahi&apos;s local flavors and tourist destinations.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link href="/faq" className="text-sm hover:text-blue-400 transition">
                  FAQs
                </Link>
              </li>
              <li>
                <Link href="/terms" className="text-sm hover:text-blue-400 transition">
                  Terms & Conditions
                </Link>
              </li>
              <li>
                <Link href="/privacy" className="text-sm hover:text-blue-400 transition">
                  Privacy Policy
                </Link>
              </li>
            </ul>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <Link href="/house-rent" className="text-sm hover:text-blue-400 transition">
                  House Rent
                </Link>
              </li>
              <li>
                <Link href="/hostel-rent" className="text-sm hover:text-blue-400 transition">
                  Hostel Rent
                </Link>
              </li>
              <li>
                <Link href="/find-doctor" className="text-sm hover:text-blue-400 transition">
                  Find Doctor
                </Link>
              </li>
              <li>
                <Link href="/catering" className="text-sm hover:text-blue-400 transition">
                  Catering Services
                </Link>
              </li>
              <li>
                <Link href="/local-foods" className="text-sm hover:text-blue-400 transition">
                  Local Foods
                </Link>
              </li>
              <li>
                <Link href="/tourism" className="text-sm hover:text-blue-400 transition">
                  Tourism
                </Link>
              </li>
            </ul>
          ...
          <div>
            ...
            <div>
              ...
              <p className="text-xs text-gray-400 mb-3">Subscribe to get updates</p>
        ...
        <div className="mt-8 pt-8 border-t border-gray-800">
          <div className="flex flex-col md:flex-row items-center justify-between gap-4">
            <div>
              <h4 className="text-white font-semibold text-sm mb-2">Download Our App</h4>
